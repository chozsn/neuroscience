#==============================================================================
# Point neuron (exponential I&F model) with 6 short dendrites.
...
medial_l   = 83.0 * um
proximal_l = 83.0 * um
length_dend  = [medial_l, medial_l, proximal_l]
length_dend *= Nbranch
distal_d   = 0.80 * um
medial_d   = 0.90 * um
proximal_d = 1.00 * um
diam_dend  = [medial_d, medial_d, proximal_d]
diam_dend *= Nbranch
...
granule_eqs = Compartments({'soma' : eqs_soma,
                           ...
                           'dend101': eqs_dendrite[3],
                           'dend102': eqs_dendrite[4],
                           'dend12': eqs_dendrite[5],
                           'dend201': eqs_dendrite[6],
                           'dend202': eqs_dendrite[7],
                           'dend22': eqs_dendrite[8]})


granule_eqs.connect('dend001', 'dend02', Ra_1)
granule_eqs.connect('dend002', 'dend02', Ra_1)
granule_eqs.connect('dend02', 'soma', Ra_2)


granule_eqs.connect('dend101', 'dend12', Ra_1)
granule_eqs.connect('dend102', 'dend12', Ra_1)
granule_eqs.connect('dend12', 'soma', Ra_2)


granule_eqs.connect('dend201', 'dend22', Ra_1)
granule_eqs.connect('dend202', 'dend22', Ra_1)
...
V_peak = [V_soma, V_peak001, V_peak002, V_peak02,
          V_peak101, V_peak102, V_peak12,
          V_peak201, V_peak202, V_peak22]
